...
public class SoloMatchEntity implements IMatchEntity{
    @Id
    ...
    public SoloMatchEntity(LocalDate date, String tier, Boolean win, Map<Long, String> positionMap, Map<Long, List<Long>> itemListMap, Map<Long, TreeSet<Long>> spellListMap, TreeSet<Long> championList, Map<Long, List<Long>> perkListMap) {
        this.date = date;
        this.tier = tier;
        this.win = win;
